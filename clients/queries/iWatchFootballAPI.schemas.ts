...
export interface Ticket {
  ...
  fixtureId: number;
  id: number;
  /** Payment information if ticket is purchased */
  payment: ;
  paymentId?: number;
  price: number;
  updatedAt?: string;
  /** User who has purchased this ticket */
  user: ;
  userId?: number;
}
...
export interface LoyaltyEvent {
  ...
  eventType: string;
  id: number;
  /** Loyalty rule that triggered this event */
  loyaltyRule: ;
  /** ID of the loyalty rule that triggered this event */
...
export interface LoyaltyRule {
  ...
  enabled: boolean;
  /** Type of loyalty event this rule applies to */
  eventType: string;
  id: number;
  /** Name of the loyalty rule */
  name: string;
  /** Credit amount to award when rule is triggered */
  rewardAmount: number;
  /** Threshold value for the rule (e.g., spending amount) */
  threshold?: number;
  updatedAt?: string;
}
...
export interface Transaction {
  ...
  description?: string;
  id: number;
  /** Payment this transaction belongs to */
  payment: ;
...
export interface LineUp {
  createdAt?: string;
  deletedAt?: string;
  /** Fixture for this line-up */
  fixture: ;
  fixtureId: number;
  formation?: string;
  id: number;
  /** Manager for this line-up */
  manager: ;
  managerId: number;
  /** Player line-ups for this line-up */
  playerLineups: [];
  /** Team for this line-up */
  team: ;
  teamId: number;
  updatedAt?: string;
}
...
export interface Goal {
  /** Player who assisted this goal */
  assistant: ;
  assistantId?: number;
  createdAt?: string;
  deletedAt?: string;
  /** Fixture where this goal was scored */
  fixture: ;
  fixtureId: number;
  id: number;
  minute: number;
...
export interface FixtureReferee {
  createdAt?: string;
  deletedAt?: string;
  /** Fixture for this referee assignment */
  fixture: ;
  fixtureId: number;
  id: number;
  /** Referee for this fixture */
  referee: ;
  refereeId: number;
...
export interface Fixture {
  ...
  goals: [];
  /** Home team for this fixture */
  homeTeam: ;
  /** ID of the home team */
  homeTeamId?: number;
  id: number;
  /** Line-ups for this fixture */
  lineUps: [];
  /** Logs for this fixture */
  logs: [];
  /** Predictions for this fixture */
  predictions: [];
  /** Referees for this fixture */
  referees: [];
  /** Season ID associated with the fixture */
  seasonId: number;
  /** Stadium where this fixture takes place */
  stadium: ;
  ...
  /** Team competition season for this fixture */
