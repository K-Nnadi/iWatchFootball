...
// import {AuthedController, NoAuthController} from '@iWatchFootball/base-tools/decorators/controller.decorator';
...
//     ) {
//         const competition = await this.competitionService.getOne(competitionId);
//         const season = await this.seasonService.getOne(seasonId);
//
//         const teams = await this.teamCompetitionSeasonService.getQuery({
...
//     ) {
//         if (!seasonId) {
//             const [currentSeason] = await this.seasonService.getQuery({
