...
export class GeneratedCli1764039977082 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "trophy" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" character varying NOT NULL, "description" character varying, "yearIntroduced" TIMESTAMP, "competitionId" integer, "teamId" integer, "playerId" integer, CONSTRAINT "PK_36c7cac00e373b7c3a7e6da3108" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "competition" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" character varying NOT NULL, "code" character varying, "type" "public"."competition_type_enum" NOT NULL DEFAULT 'League', "country" character varying NOT NULL, CONSTRAINT "PK_a52a6248db574777b226e9445bc" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "commsPreference" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" integer NOT NULL, "emailNotifications" "public"."comms_preference_emailnotifications_enum" NOT NULL DEFAULT 'DAILY', "smsNotifications" "public"."comms_preference_smsnotifications_enum" NOT NULL DEFAULT 'NEVER', "pushNotifications" "public"."comms_preference_pushnotifications_enum" NOT NULL DEFAULT 'IMMEDIATE', "inAppNotifications" "public"."comms_preference_inappnotifications_enum" NOT NULL DEFAULT 'IMMEDIATE', "marketingEmails" "public"."comms_preference_marketingemails_enum" NOT NULL DEFAULT 'WEEKLY', "newsletterEmails" "public"."comms_preference_newsletteremails_enum" NOT NULL DEFAULT 'WEEKLY', "matchReminders" "public"."comms_preference_matchreminders_enum" NOT NULL DEFAULT 'DAILY', "language" "public"."comms_preference_language_enum" NOT NULL DEFAULT 'EN', "timezone" character varying, CONSTRAINT "REL_afcec79a6fe61625c2db8a1d73" UNIQUE ("userId"), CONSTRAINT "PK_9972ebf0f8c1040b476c6c612eb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "credit" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "balance" numeric(10,2) NOT NULL DEFAULT '0', "userId" integer NOT NULL, CONSTRAINT "UQ_9f5fdca6886a2ecdb6d34b23d70" UNIQUE ("userId"), CONSTRAINT "PK_c98add8e192ded18b69c3e345a5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "ticket" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "category" character varying(50) NOT NULL, "price" numeric(10,2) NOT NULL, "fixtureId" integer NOT NULL, "userId" integer, "paymentId" integer, CONSTRAINT "PK_d9a0835407701eb86f874474b7c" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`
            ...
            END $$;
        `);
        await queryRunner.query(`CREATE TABLE "paymentProvider" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" character varying(100) NOT NULL, "slug" character varying(50) NOT NULL, "type" "public"."payment_provider_type_enum" NOT NULL, "apiKey" text NOT NULL, "enabled" boolean NOT NULL DEFAULT false, "logoUrl" character varying(500), "metadata" json, CONSTRAINT "UQ_c3ffc2f1527f6f12d016482a384" UNIQUE ("slug"), CONSTRAINT "PK_ea94f42b6c88e9191c3649d7522" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "payment" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "method" character varying(20) NOT NULL, "status" character varying NOT NULL, "amount" numeric(10,2), "paymentProviderId" integer, CONSTRAINT "PK_fcaec7df5adf9cac408c686b2ab" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "transaction" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "type" character varying(50) NOT NULL, "amount" numeric(10,2) NOT NULL, "description" character varying(500), "paymentId" integer, "userId" integer NOT NULL, CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "loyaltyScheme" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "eventType" character varying(50) NOT NULL, "name" character varying(100) NOT NULL, "description" character varying(500), "threshold" numeric(10,2), "rewardAmount" numeric(10,2) NOT NULL, "enabled" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_12177a1538432d5690cb24eba83" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "loyaltyEvent" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "eventType" character varying(50) NOT NULL, "userId" integer NOT NULL, "loyaltySchemeId" integer, "rewardAmount" numeric(10,2) NOT NULL, "description" character varying(500), CONSTRAINT "PK_f91e996248a0b874eecb844fbed" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "newsArticle" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "title" character varying(500) NOT NULL, "summary" text NOT NULL, "url" character varying(1000) NOT NULL, "imageUrl" character varying(1000), "source" character varying(200) NOT NULL, "publishedAt" TIMESTAMP NOT NULL, "category" character varying(100), "author" character varying(200), CONSTRAINT "UQ_c8124b9d4eefd9efeb340dd1b6a" UNIQUE ("url"), CONSTRAINT "PK_12e2ec4b5482dadc50ee88e0da1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "genericToken" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "token" character varying NOT NULL, "type" "public"."genericToken_type_enum" NOT NULL, "expiry" character varying NOT NULL, "userEmail" character varying, "userId" integer NOT NULL, CONSTRAINT "PK_9cda1245cc86afda14979b9e38b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "competitionStanding" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "competitionId" integer NOT NULL, "seasonId" integer NOT NULL, "teamId" integer NOT NULL, "position" integer NOT NULL, "played" integer NOT NULL, "won" integer NOT NULL, "drawn" integer NOT NULL, "lost" integer NOT NULL, "goalsFor" integer NOT NULL, "goalsAgainst" integer NOT NULL, "goalDifference" integer NOT NULL, "points" integer NOT NULL, "form" character varying, "positionChange" integer, CONSTRAINT "PK_5838c0b5c44b4fc0f317b40d9fe" PRIMARY KEY ("id"))`);
